 ...
 */
export function transformedRect(rect, transform, msg) {
  if (!isValidRect(rect)) {
 ...
 */
export function alignedRect(rect, viewPortRect, diffRect) {
  diffRect = diffRect || {
    left: 0,
    top: 0,
    right: 0,
  ...
  viewPortRect.left += diffRect.left;
  viewPortRect.top += diffRect.top;
  viewPortRect.right -= diffRect.right;
  viewPortRect.bottom -= diffRect.bottom;
  ...
  // console.log(viewPortRect.bottom);
